...
public class Console {
	...
	public static String getString(String prompt, ArrayList<String> list) {
		String s = null;
		boolean isValid = false;
		while(!isValid) {
			System.out.print(prompt);
			...
			if (list.contains(s)) {
				...
				System.out.println("Error! Not a valid category. Try again.");
			}
	...
	public static void printMoviesByCat(ArrayList<Movie> list) {
		for(Movie film : list) {
